...
import com.admin.model.vo.TableInfo;
...
public class AdminGeneratorServiceImpl extends ServiceImpl<IColumnInfoMapper, ColumnInfoModel>
	...
	public Object getTables(String name, int[] startEnd) {
		List<CaseInsensitiveMap<String, Object>> result = this.baseMapper.getByTableName(
				StringUtils.isNotBlank(name) ? ("%" + name + "%") : "%%", startEnd[0], startEnd[1] - startEnd[0]);
		List<TableInfo> tableInfos = new ArrayList<>();
		for (CaseInsensitiveMap<String, Object> obj : result) {
	...
	public List<ColumnInfoModel> query(String tableName) {
		List<CaseInsensitiveMap<String, Object>> result = this.baseMapper.getByTableNameOrderByPosition(tableName);
