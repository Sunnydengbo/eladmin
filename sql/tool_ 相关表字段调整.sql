...
alter table tool_alipay_config
    CHANGE id config_id BIGINT(20) COMMENT 'ID';
...
alter table tool_local_storage
    CHANGE id storage_id BIGINT(20) AUTO_INCREMENT COMMENT 'ID';
/* 加入通用字段 */
alter table tool_local_storage
...
alter table tool_picture
    CHANGE id picture_id BIGINT(20) AUTO_INCREMENT COMMENT 'ID';
-- tool_picture end --
...
alter table tool_qiniu_content
    CHANGE id content_id BIGINT(20) AUTO_INCREMENT COMMENT 'ID';
