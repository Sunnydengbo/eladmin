...
public interface IUserMapper extends BaseMapper<UserModel> {
	 ...
	 */
	@Results({
			@Result(column = "dept_id", property = "dept", one = @One(select = "com.admin.modules.system.mapper.IDeptMapper.selectLink")),
			@Result(column = "job_id", property = "job", one = @One(select = "com.admin.modules.system.mapper.IJobMapper.selectLink")),})
