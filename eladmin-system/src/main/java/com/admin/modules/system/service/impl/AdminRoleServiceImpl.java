...
import com.admin.modules.system.mapper.IRoleMapper;
...
import com.admin.modules.system.model.RolesMenusModel;
...
import com.admin.modules.system.service.IRolesMenusService;
...
public class AdminRoleServiceImpl extends ServiceImpl<IRoleMapper, RoleModel> implements IRoleService {
	...
	public List<RoleDto> queryAll() {
		QueryWrapper<RoleModel> query = new QueryWrapper<RoleModel>();
	...
	private QueryWrapper<RoleModel> buildWrapper(RoleQueryCriteria criteria) {
		...
		if (null != criteria) {
			...
			query = new QueryWrapper<RoleModel>();
			query.lambda()
	...
	public void updateMenu(RoleModel resources, RoleDto roleDTO) {
		...
		this.saveOrUpdate(role);
		QueryWrapper<RolesMenusModel> query = new QueryWrapper<RolesMenusModel>();
	...
	public void delCaches(Long id) {
		List<UserModel> users = userMapper.findByRoleId(id);
		Set<Long> userIds = users.stream().map(UserModel::getId).collect(Collectors.toSet());
