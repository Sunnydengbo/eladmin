...
import com.admin.modules.system.controller.dto.DictDetailDto;
import com.admin.modules.system.controller.dto.DictDetailQueryCriteria;
import com.admin.modules.system.mapper.IDictDetailMapper;
import com.admin.modules.system.mapper.IDictMapper;
import com.admin.modules.system.model.DictDetailModel;
import com.admin.modules.system.model.DictModel;
import com.admin.modules.system.service.IDictDetailService;
...
public class AdminDictDetailServiceImpl extends ServiceImpl<IDictDetailMapper, DictDetailModel>
	...
	public void delCaches(DictDetailModel dictDetail) {
		DictModel dict = Optional.ofNullable(dictMapper.selectById(dictDetail.getDictId())).orElseGet(DictModel::new);
