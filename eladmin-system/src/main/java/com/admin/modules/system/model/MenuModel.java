 ...
 */
package com.admin.modules.system.model;
...
public class MenuModel extends BaseModel<MenuModel> implements Serializable {
    ...
    @TableField(value = AdminFields.MENU_NAME, updateStrategy = FieldStrategy.IGNORED)
    ...
    @TableField(value = AdminFields.MENU_COMPONENT, updateStrategy = FieldStrategy.IGNORED)
    ...
    @TableField(value = AdminFields.MENU_PERMISSION, updateStrategy = FieldStrategy.IGNORED)
