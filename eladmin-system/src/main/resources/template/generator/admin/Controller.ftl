...
public class ${className}Controller {
    ...
    @PreAuthorize("@el.check('${changeClassName}:list')")
    public ResponseEntity<?> query(${className}QueryCriteria criteria, Page< ${className}Model> page){
    ...
    public ResponseEntity<?> create(@Validated @RequestBody ${className}Model resources){
    ...
    public ResponseEntity<?> update(@Validated @RequestBody ${className}Model resources){
