...
import com.admin.mapper.ILogMapper;
import com.admin.model.LogModel;
import com.admin.service.ILogService;
...
public class AdminLogServiceImpl extends ServiceImpl<ILogMapper, LogModel> implements ILogService {
    ...
    public void save(String username, String browser, String ip, ProceedingJoinPoint joinPoint, LogModel log) {
        ...
        if (argValues != null) {
            List<String> excludes = Arrays.asList(aopLog.excludes());
            for (int i = 0; i < argValues.length; i++) {
                if (excludes.contains(argNames[i])) {
                    continue;
                }
