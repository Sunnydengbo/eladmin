<template>
  <el-dialog :visible.sync="dialog" append-to-body title="执行日志" width="88%">
    ...
    <div class="head-container">
      ...
      />
      <el-select v-model="query.isSuccess" class="filter-item" clearable placeholder="日志状态" size="small"
                 style="width: 110px" @change="toQuery">
    ...
    <el-table v-loading="loading" :data="data" style="width: 100%;margin-top: -10px;">
      ...
      <el-table-column label="异常详情" prop="createTime" width="110px">
        <template slot-scope="scope">
          <el-button v-show="scope.row.exceptionDetail" size="mini" type="text"
                     @click="info(scope.row.exceptionDetail)">查看详情
          </el-button>
        </template>
      </el-table-column>
