    ...
    <div v-else>
      ...
      <div class="head-container">
        <div v-if="crud.props.searchToggle">
          <!-- 搜索 -->
          <el-input v-model="query.label" class="filter-item" clearable placeholder="输入字典标签查询" size="small"
      ...
      <el-dialog :before-close="crud.cancelCU" :close-on-click-modal="false" :title="crud.status.title"
        ...
        <el-form ref="form" :model="form" :rules="rules" label-width="80px" size="small">
          ...
          <el-form-item label="排序" prop="dictSort">
            <el-input-number v-model.number="form.dictSort" :max="999" :min="0" controls-position="right"
                             style="width: 370px;"/>
          </el-form-item>
        </el-form>
