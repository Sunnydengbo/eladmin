<template>
  <el-dialog :close-on-click-modal="false" :visible.sync="dialog" append-to-body title="系统还原" width="800px">
    <!--工具栏-->
    ...
    <div slot="footer" class="dialog-footer">
      ...
      <el-button v-permission="['admin','deploy:add']" :loading="submitLoading" type="primary" @click="doSubmit">确认
      </el-button>
    </div>
    <!--分页组件-->
    <el-pagination
