<template>
  <div>
    <el-form ref="form" :model="form" :rules="rules" label-width="100px" size="small" style="margin-top: 6px;">
      ...
      >
        ...
        <el-button icon="el-icon-minus" style="margin-left:0;" @click.prevent="removeDomain(domain)"/>
      </el-form-item>
      <div ref="editor" class="editor"/>
      <el-button :loading="loading" size="medium" style="margin-left:1.6%;" type="primary" @click="doSubmit">发送邮件
      </el-button>
    </el-form>
  </div>
</template>
